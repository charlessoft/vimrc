...
function! CommentLine()
  ...
  " for .cc or .cxx or .cpp or .hpp or .java or .C files use //
  if file_name =~ '\.cc$' || file_name =~ '\.cxx$' || file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
...
function! RangeCommentLine()
  ...
  " for .cc or .cpp or .hpp or .java or .C files use //
  if file_name =~ '\.cc$' || file_name =~ '\.cxx$' || file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
...
function! RangeUnCommentLine()
  ...
  " for .cc or .cxx .cpp or .hpp or .java files use //
  if file_name =~ '\.cc$' || file_name =~ '\.cxx$' || file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
